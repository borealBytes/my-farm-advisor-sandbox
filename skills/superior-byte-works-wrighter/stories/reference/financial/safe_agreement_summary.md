# SAFE Agreement Summary Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | SAFE Agreement Summary Template |
| **Category** | Financial |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Summarize SAFE mechanics, conversion triggers, and investor rights.
...
```mermaid
flowchart LR
    N1["Define SAFE Inputs"]
    N2["Map Conversion Events"]
    N3["Estimate Ownership"]
    N4["Check Legal Terms"]
    N5["Archive"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
...
$$
\\text{Conversion Price} = \\min(\\text{Valuation Cap Price}, \\text{Discounted Round Price})
$$
