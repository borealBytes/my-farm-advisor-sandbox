# Term Sheet Negotiation Tracker Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Term Sheet Negotiation Tracker Template |
| **Category** | Financial |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Capture economics and control terms through negotiation stages.
...
$$
\\text{Implied Post-Money} = \\frac{\\text{Investment Amount}}{\\text{Equity Sold}}
$$
