...
| Field | Value |
| ----- | ----- |
| **Document Title** | Career Ladder Template |
| **Category** | Hr |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Define role progression, expectations, and growth criteria.
...
flowchart LR
    N1["Define Tracks"]
    N2["Specify Level Outcomes"]
    N3["Map Skills"]
    N4["Train Managers"]
    N5["Review Promotions"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
    N4 --> N5
...
$$
\\text{Readiness Score} = \\frac{\\text{Met Criteria}}{\\text{Total Criteria}}
$$
