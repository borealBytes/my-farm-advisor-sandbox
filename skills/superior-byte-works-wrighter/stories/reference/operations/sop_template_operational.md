...
| Field | Value |
| ----- | ----- |
| **Document Title** | Operational SOP Template |
| **Category** | Operations |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Document repeatable standard operating procedures with controls.
...
$$
\\text{SOP Compliance Rate} = \\frac{\\text{Compliant Runs}}{\\text{Total Runs}}
$$
