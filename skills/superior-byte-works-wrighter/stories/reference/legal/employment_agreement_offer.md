# Employment Agreement Offer Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Employment Agreement Offer Template |
| **Category** | Legal |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Outline role, compensation, obligations, and termination clauses.
...
$$
\\text{Total Compensation} = \\text{Base} + \\text{Bonus} + \\text{Equity Value}
$$
