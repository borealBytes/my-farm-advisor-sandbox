...
| Field | Value |
| ----- | ----- |
| **Document Title** | SaaS Terms of Service Template |
| **Category** | Legal |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Define platform usage rights, restrictions, and liabilities.
...
$$
\\text{Service Credit} = \\text{Monthly Fee} \\times \\text{Credit Percentage}
$$
