...
| Field | Value |
| ----- | ----- |
| **Document Title** | Data Processing Addendum Template |
| **Category** | Legal |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Specify processing roles, safeguards, and sub-processor controls.
...
```mermaid
flowchart LR
    N1["Define Data Roles"]
    N2["List Controls"]
    N3["Set SCC Mechanism"]
    N4["Review with Counsel"]
    N5["Sign"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
...
$$
\\text{Breach Notification Window} = t_{report} - t_{discovery}
$$
