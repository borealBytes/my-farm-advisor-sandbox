...
| Field | Value |
| ----- | ----- |
| **Document Title** | Brand Voice Guide Template |
| **Category** | Marketing |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Codify tone, style guardrails, and examples by channel.
...
$$
\\text{Voice Consistency} = \\frac{\\text{Compliant Assets}}{\\text{Reviewed Assets}}
$$
