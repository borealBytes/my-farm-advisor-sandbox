# Campaign Experiment Backlog Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Campaign Experiment Backlog Template |
| **Category** | Marketing |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Prioritize growth experiments with hypotheses and learning goals.
...
$$
\\text{ICE Score} = \\frac{Impact + Confidence + Ease}{3}
$$
