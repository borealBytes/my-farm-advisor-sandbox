# Email Template Library Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Email Template Library Template |
| **Category** | Marketing |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Maintain reusable lifecycle and campaign email templates.
...
$$
\\text{Email CTR} = \\frac{\\text{Unique Clicks}}{\\text{Delivered Emails}}
$$
