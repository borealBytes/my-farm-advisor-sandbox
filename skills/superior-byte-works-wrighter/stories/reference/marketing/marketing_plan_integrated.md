# Integrated Marketing Plan Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Integrated Marketing Plan Template |
| **Category** | Marketing |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Coordinate channels, budget, goals, and reporting cadence.
...
$$
\\text{ROMI} = \\frac{\\text{Incremental Revenue} - \\text{Marketing Spend}}{\\text{Marketing Spend}}
$$
