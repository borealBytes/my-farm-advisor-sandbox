# Quarterly Social Media Calendar Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Quarterly Social Media Calendar Template |
| **Category** | Marketing |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Plan social publishing themes, assets, and ownership.
...
$$
\\text{Engagement Rate} = \\frac{\\text{Interactions}}{\\text{Impressions}}
$$
