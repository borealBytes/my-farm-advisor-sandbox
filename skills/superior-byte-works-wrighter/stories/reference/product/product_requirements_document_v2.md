...
| Field | Value |
| ----- | ----- |
| **Document Title** | Product Requirements Document (PRD) Template |
| **Category** | Product |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Capture problem framing, requirements, metrics, and rollout plan.
...
$$
\\text{Opportunity Score} = \\text{Reach} \\times \\text{Impact} \\times \\text{Confidence}
$$
