...
| Field | Value |
| ----- | ----- |
| **Document Title** | Feature Specification Template |
| **Category** | Product |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Specify behavior, edge cases, dependencies, and acceptance criteria.
...
$$
\\text{Readiness} = \\frac{\\text{Accepted Criteria}}{\\text{Total Criteria}}
$$
