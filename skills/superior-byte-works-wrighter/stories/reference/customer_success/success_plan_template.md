...
| Field | Value |
| ----- | ----- |
| **Document Title** | Customer Success Plan Template |
...
Align on outcomes, milestones, and adoption strategy.
...
$$
\\text{Outcome Attainment} = \\frac{\\text{Milestones Met}}{\\text{Milestones Planned}}
$$
