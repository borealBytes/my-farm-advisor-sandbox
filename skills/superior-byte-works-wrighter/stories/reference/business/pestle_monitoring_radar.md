# PESTLE Monitoring Radar Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | PESTLE Monitoring Radar Template |
| **Category** | Business |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Track macro-environment signals and decision impact by factor.
...
$$
\\text{Signal Score} = \\sum_{i=1}^{n}(w_i \\times s_i)
$$
