...
| Field | Value |
| ----- | ----- |
| **Document Title** | SWOT Analysis Workshop Template |
| **Category** | Business |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Structure a facilitated SWOT session and convert findings into actions.
