# 3-Statement Financial Projections Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | 3-Statement Financial Projections Template |
| **Category** | Financial |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Build linked income statement, balance sheet, and cash flow forecasts.
...
$$
\\text{Free Cash Flow} = EBIT(1-t) + D\\&A - CapEx - \\Delta NWC
$$
