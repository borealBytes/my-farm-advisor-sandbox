...
| Field | Value |
| ----- | ----- |
| **Document Title** | Unit Economics Dashboard Template |
| **Category** | Financial |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Track contribution margin, payback period, and growth efficiency.
...
$$
\\text{LTV:CAC} = \\frac{ARPA \\times GM \\times \\text{Lifetime}}{CAC}
$$
