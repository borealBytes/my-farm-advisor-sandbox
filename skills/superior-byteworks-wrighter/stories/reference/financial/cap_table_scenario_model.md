# Cap Table Scenario Model Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Cap Table Scenario Model Template |
| **Category** | Financial |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Track ownership, dilution, and scenario outcomes across rounds.
...
```mermaid
flowchart LR
    N1["Input Stakeholders"]
    N2["Model Round"]
    N3["Apply Dilution"]
    N4["Validate Totals"]
    N5["Publish Cap Table"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
    N4 --> N5
...
$$
\\text{Ownership}\\% = \\frac{\\text{Shares Held}}{\\text{Total Diluted Shares}} \\times 100
$$
