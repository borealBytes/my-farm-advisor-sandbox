...
| Field | Value |
| ----- | ----- |
| **Document Title** | Contractor Agreement Template |
| **Category** | Legal |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Set independent contractor scope, payment, and IP ownership terms.
...
$$
\\text{Invoice Total} = \\text{Hours} \\times \\text{Rate} + \\text{Approved Expenses}
$$
