...
| Field | Value |
| ----- | ----- |
| **Document Title** | Mutual NDA Template |
| **Category** | Legal |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Draft bilateral confidentiality terms and handling requirements.
...
flowchart LR
    N1["Define Parties"]
    N2["Set Confidential Scope"]
    N3["Specify Exclusions"]
    N4["Set Term"]
    N5["Execute"]
    N1 --> N2
    N2 --> N3
...
$$
\\text{Risk Score} = \\sum_{i=1}^{n}(w_i \\times r_i)
$$
