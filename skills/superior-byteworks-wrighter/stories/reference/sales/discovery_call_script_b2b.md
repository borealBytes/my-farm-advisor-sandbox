# B2B Discovery Call Script Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | B2B Discovery Call Script Template |
| **Category** | Sales |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Guide structured qualification and pain discovery conversations.
...
$$
\\text{Qualification Score} = 0.3B + 0.3A + 0.2N + 0.2T
$$
