# Value-Based Demo Script Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Value-Based Demo Script Template |
| **Category** | Sales |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Run outcome-driven demos mapped to buyer priorities.
...
$$
\\text{Demo Relevance} = \\frac{\\text{Matched Use Cases}}{\\text{Total Buyer Priorities}}
$$
