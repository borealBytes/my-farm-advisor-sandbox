# Objection Handling Guide Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Objection Handling Guide Template |
| **Category** | Sales |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Standardize responses for common objections with proof points.
...
```mermaid
flowchart LR
    N1["Capture Objection"]
    N2["Classify Type"]
    N3["Respond with Evidence"]
    N4["Validate Concern"]
    N5["Advance Deal"]
    N1 --> N2
    N2 --> N3
...
$$
\\text{Objection Resolution Rate} = \\frac{\\text{Resolved}}{\\text{Raised}}
$$
