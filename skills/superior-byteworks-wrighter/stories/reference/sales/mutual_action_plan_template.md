...
| Field | Value |
| ----- | ----- |
| **Document Title** | Mutual Action Plan Template |
| **Category** | Sales |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Align buyer and seller milestones required for close.
...
```mermaid
flowchart LR
    N1["Align Stakeholders"]
    N2["Set Milestones"]
    N3["Track Dependencies"]
    N4["Escalate Risks"]
    N5["Close/Won"]
    N1 --> N2
    N2 --> N3
...
$$
\\text{Plan Confidence} = \\frac{\\text{Completed Milestones}}{\\text{Total Milestones}}
$$
