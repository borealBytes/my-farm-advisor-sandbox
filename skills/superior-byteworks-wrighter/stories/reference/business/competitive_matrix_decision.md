# Competitive Matrix Decision Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Competitive Matrix Decision Template |
| **Category** | Business |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Compare strategic alternatives against competitors and criteria.
...
flowchart LR
    N1["Select Criteria"]
    N2["Score Competitors"]
    N3["Weight Factors"]
    N4["Choose Option"]
    N5["Document Rationale"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
    N4 --> N5
...
$$
\\text{Option Score} = \\sum_{i=1}^{n}(w_i \\times r_i)
$$
