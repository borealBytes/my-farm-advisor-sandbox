...
| Field | Value |
| ----- | ----- |
| **Document Title** | Product Decision Log Template |
| **Category** | Product |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Record key decisions, rationale, alternatives, and outcomes.
...
$$
\\text{Decision Reversal Rate} = \\frac{\\text{Reversed Decisions}}{\\text{Total Decisions}}
$$
