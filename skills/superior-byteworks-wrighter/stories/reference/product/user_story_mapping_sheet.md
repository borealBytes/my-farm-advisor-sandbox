...
| Field | Value |
| ----- | ----- |
| **Document Title** | User Story Mapping Template |
| **Category** | Product |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Organize user activities, tasks, and release slices.
...
$$
\\text{Slice Value} = \\frac{\\text{User Impact}}{\\text{Effort}}
$$
