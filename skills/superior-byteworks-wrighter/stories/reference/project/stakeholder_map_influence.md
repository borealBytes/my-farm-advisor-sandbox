...
| Field | Value |
| ----- | ----- |
| **Document Title** | Stakeholder Map Template |
| **Category** | Project |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Map influence and interest to drive communication strategy.
...
```mermaid
flowchart LR
    N1["List Stakeholders"]
    N2["Score Influence/Interest"]
    N3["Assign Owner"]
    N4["Plan Engagement"]
    N5["Review"]
    N1 --> N2
...
$$
\\text{Stakeholder Priority} = 0.6I_f + 0.4I_t
$$
