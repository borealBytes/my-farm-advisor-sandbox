...
| Field | Value |
| ----- | ----- |
| **Document Title** | Project Dependency Tracker Template |
| **Category** | Project |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Track upstream/downstream dependencies and delivery confidence.
...
```mermaid
flowchart LR
    N1["Identify Dependencies"]
    N2["Assess Criticality"]
    N3["Plan Contingencies"]
    N4["Monitor Dates"]
    N5["Resolve"]
    N1 --> N2
    N2 --> N3
...
$$
\\text{Dependency Risk} = \\sum_{i=1}^{n}(c_i \\times p_i)
$$
