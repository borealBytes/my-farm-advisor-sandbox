...
| Field | Value |
| ----- | ----- |
| **Document Title** | Project Communication Plan Template |
| **Category** | Project |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Define audience, cadence, channels, and message owner.
...
flowchart LR
    N1["Define Audiences"]
    N2["Set Cadence"]
    N3["Prepare Templates"]
    N4["Send Updates"]
    N5["Measure Effectiveness"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
    N4 --> N5
...
$$
\\text{Communication Coverage} = \\frac{\\text{Delivered Updates}}{\\text{Planned Updates}}
$$
