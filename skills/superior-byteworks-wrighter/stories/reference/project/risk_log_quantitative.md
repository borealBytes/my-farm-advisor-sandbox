# Quantitative Risk Log Template
...
| Field | Value |
| ----- | ----- |
| **Document Title** | Quantitative Risk Log Template |
| **Category** | Project |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Track risk probability, impact, mitigation, and exposure.
...
$$
\\text{Risk Exposure} = P(\\text{risk}) \\times \\text{Impact}
$$
