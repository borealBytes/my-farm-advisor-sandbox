...
| Field | Value |
| ----- | ----- |
| **Document Title** | Enterprise Policy Template |
| **Category** | Operations |
| **Version** | 1.0 |
| **Status** | Draft |
| **Owner** | `[Owner Name]` |
...
Write policies with purpose, controls, and enforcement model.
...
flowchart LR
    N1["Define Purpose"]
    N2["Write Policy Statements"]
    N3["Assign Accountability"]
    N4["Communicate"]
    N5["Audit"]
    N1 --> N2
    N2 --> N3
...
$$
\\text{Policy Adherence} = \\frac{\\text{Compliant Audits}}{\\text{Total Audits}}
$$
